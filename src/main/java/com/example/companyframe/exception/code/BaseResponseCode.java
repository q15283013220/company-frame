package com.example.companyframe.exception.code;

import com.example.companyframe.exception.code.ResponseCodeInterface;
...
public enum BaseResponseCode implements ResponseCodeInterface {
    ...
    OPERATION_MENU_PERMISSION_URL_CODE_NULL(4000017, "菜单权限编码不能为空"),
